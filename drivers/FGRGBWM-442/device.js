...
class FibaroRGBWControllerTwoDevice extends ZwaveDevice {
    ...
    onMeshInit() {
        ...
        ================================================================
        */
        this.registerCapability('onoff', 'SWITCH_COLOR_V3', {
            multiChannelNodeId: 1,
        });

        this.registerCapability('dim', 'SWITCH_COLOR_V3');
        ...
        */
        ...
        this.registerCapabilityListener('light_mode', async (value, opts) => {
            ...
            if (value === 'color') {
                ...
                if (stripType === 'cct') {
                    ...
                    let HSV = this.temperatureGradient.hsvAt(temperature).toHsv();
                    HSV.s *= 100;
                    HSV.v = dim * 100;
        ...
        ================================================================
         */
        this.registerCapability('meter_power', 'METER_V3');
        this.registerCapability('measure_power', 'SENSOR_MULTILEVEL_V11');
        ...
        ================================================================
         */
        this.registerCapability('measure_voltage.input1', 'SWITCH_COLOR_V3', {
            multiChannelNodeId: 2,
          	get: 'SWITCH_COLOR_V3_GET',
          	getOpts: {
          		getOnStart: true,
          	},
            report: 'SWITCH_COLOR_V3_REPORT',
            reportParser: (report) => this._reportParser(report, 2),
        });
        this.registerCapability('measure_voltage.input2', 'SWITCH_COLOR_V3', {
        ...
        this.registerCapability('measure_voltage.input3', 'SWITCH_COLOR_V3', {
        ...
        this.registerCapability('measure_voltage.input4', 'SWITCH_COLOR_V3', {
...
module.exports = FibaroRGBWControllerTwoDevice;
